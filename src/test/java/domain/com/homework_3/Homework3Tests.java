...
public class Homework3Tests {
     ...
     *  $("h1 div") -> этот локатор ищет все вложенные div элементы внутри h1 не только первого уровня вложенности,
     *  но и всех последующих вложенностей, а это подход $("h1").$("div") означает, что div будет искаться исключительно
     *  среди вложенных элементов внутри h1 только непосредственно на первом уровне вложенности.
